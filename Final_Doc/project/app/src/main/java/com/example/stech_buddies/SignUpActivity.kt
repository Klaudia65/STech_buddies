...
class SignUpActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivitySignUpBinding // View binding for SignUpActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Populate spinner with a list of majors
        val majors = arrayOf(
                            ...
                            if (userId != null) {
                                db.collection("users").document(userId)
                                    ...
                                    .addOnSuccessListener {
                                        ...
                                        finish() // Close SignUpActivity after registration
                                    }
        ...
        // Handle cancel button to return to previous screen
